...
exports.UserControllerLoginViaEmail = void 0;
...
class UserControllerLoginViaEmail {
    /**
     - To create a user: POST on UserRoute User ("/user-login-via-username")
     */
    constructor(app) {
        app.post(user_routes_1.UserRoutes.UserLoginViaEmail, async (req, res) => {
            ...
            try {
                ...
                //console.log(user)
                const match = (user && user.username && password && user.passwordHash) ? await hash_manager_1.HashManager.compare(password, user.passwordHash) : false;
                //console.log(match)
...
exports.UserControllerLoginViaEmail = UserControllerLoginViaEmail;
